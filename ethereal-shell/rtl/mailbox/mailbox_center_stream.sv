...
// Provenance: Migrated from github.com/BaiTian6641/TinyGPU-FPGA/ip/mailbox/mailbox_center_stream.sv
...
module mailbox_center_stream #(
  ...
  function automatic logic is_global(input logic [NODE_ID_WIDTH-1:0] dest);
    // Only the cluster field [15:8] routes at the center (spec §3.2); the
