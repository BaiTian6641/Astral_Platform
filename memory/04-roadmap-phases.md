...
- **Next:** Routable CB **Step 2** — integrate connection_block into fabric_top (replace tap) + unit=CB cfg decode + end-to-end CLB→轨→CLB routability TB → unlocks E0-MAP2 (VPR arch) + circuit-run demo.
