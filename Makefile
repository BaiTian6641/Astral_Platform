...
ifeq ($(IVERILOG),)
	...
	@echo "[test-sv] tb_npu_t";       $(IVERILOG) -g2012 -o /tmp/tb_npu_t -Iethereal-fabric/rtl/inf ethereal-fabric/rtl/tile/pe_int8.sv ethereal-fabric/rtl/tile/npu_arr8.sv ethereal-fabric/rtl/tile/npu_t.sv ethereal-fabric/tests/npu/tb_npu_t.sv 2>/dev/null && vvp /tmp/tb_npu_t | grep -q "TEST PASSED" && echo "  PASS"
	@echo "[test-sv] tb_npu_tinyml";  $(IVERILOG) -g2012 -o /tmp/tb_npu_tiny -Iethereal-fabric/rtl/inf ethereal-fabric/rtl/tile/pe_int8.sv ethereal-fabric/rtl/tile/npu_arr8.sv ethereal-fabric/rtl/tile/npu_t.sv ethereal-fabric/tests/npu/tb_npu_tinyml.sv 2>/dev/null && vvp /tmp/tb_npu_tiny | grep -q "TEST PASSED" && echo "  PASS"
	@echo "[test-sv] tb_npu_isolation"; $(IVERILOG) -g2012 -o /tmp/tb_npu_iso -Iethereal-fabric/rtl/inf ethereal-fabric/rtl/tile/pe_int8.sv ethereal-fabric/rtl/tile/npu_arr8.sv ethereal-fabric/rtl/tile/npu_t.sv ethereal-fabric/tests/npu/tb_npu_isolation.sv 2>/dev/null && vvp /tmp/tb_npu_iso | grep -q "TEST PASSED" && echo "  PASS"
	@echo "[test-sv] tb_npu_sat";         $(IVERILOG) -g2012 -o /tmp/tb_npu_sat -Iethereal-fabric/rtl/inf ethereal-fabric/rtl/tile/pe_int8.sv ethereal-fabric/rtl/tile/npu_arr8.sv ethereal-fabric/rtl/tile/npu_t.sv ethereal-fabric/tests/npu/tb_npu_sat.sv 2>/dev/null && vvp /tmp/tb_npu_sat | grep -q "TEST PASSED" && echo "  PASS (~1.5 min)"
	@echo "[test-sv] tb_npu_isolation (negative control, must leak)"; $(IVERILOG) -g2012 -DNPU_LEAK_NEGCTL -o /tmp/tb_npu_iso_leak -Iethereal-fabric/rtl/inf ethereal-fabric/rtl/tile/pe_int8.sv ethereal-fabric/rtl/tile/npu_arr8.sv ethereal-fabric/rtl/tile/npu_t.sv ethereal-fabric/tests/npu/tb_npu_isolation.sv 2>/dev/null && (vvp /tmp/tb_npu_iso_leak | grep -q "TEST PASSED" && exit 1 || echo "  PASS (leak detected)")
